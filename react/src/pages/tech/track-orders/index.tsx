...
const TrackTechOrders = () => {
    ...
    useEffect(() => {
      ...
      const fetchCartItems = async () => {
        const items = await getCartItems("tech");
        setCartItems(items);
      };
      fetchCartItems();
      calculateTotal();
    ...
    <Container active="footwear">
      <div className="pt-[15vh] pb-10 lg:w-[90vw] mx-auto">
        <div className="flex space-x-6 w-[90vw] mx-auto">
          <NavLink to="/tmp-5/home" className="flex items-center cursor-pointer space-x-2">
            <BackIcon />
...
export default TrackTechOrders;
