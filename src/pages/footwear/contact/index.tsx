...
import {
  ...
  CoTwitter,
  CoYoutube,
} from "../../../components/svgs/contactIcons";
import {
  EmailIcon,
  LocationIcon,
  Phone,
  ...
  return (
    <Container>
      <div className="py-[10vh] flex lg:flex-row flex-col-reverse justify-between">
        <div className="bg-[#000] text-[#fff] py-10 lg:w-[35%] lg:pl-20 pl-6 pr-6 mt-10 lg:mt-0">
        ...
        <div className="lg:w-[50%] lg:mr-20 mr-6 ml-6 lg:ml-0 pt-16">
          <h2 className="lg:text-[36px] text-[24px] font-semibold">We&apos;re here for you</h2>
          ...
          <div className="form mt-10 space-y-10">
            ...
            <button className="w-[100%] py-3 bg-[#000] text-[#fff] rounded-lg">
              Get started
            </button>
          </div>
        </div>
